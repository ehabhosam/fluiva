...
export default function ControlledCounter(props: ControlledCounterProps) {
  ...
  return (
    <div className="flex gap-3 items-center">
      <button
        className="flex items-center justify-center w-10 h-10 rounded-full bg-plansync-purple-600 text-white cursor-pointer z-10"
      ...
      <button
        className="flex items-center justify-center w-10 h-10 rounded-full bg-plansync-purple-600 text-white"
