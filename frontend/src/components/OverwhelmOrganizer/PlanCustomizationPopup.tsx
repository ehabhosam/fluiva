    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="max-w-lg">
                <DialogHeader>
                    <DialogTitle className="text-xl font-bold text-Fluiva-purple-900 flex items-center gap-2">
                        <Sparkles className="w-5 h-5" />
                        Customize Your Plan
                    </DialogTitle>
                    <DialogDescription>
                        Give your plan a personal touch! Both fields are
                        optional - we'll use smart defaults if you leave them
                        empty.
                    </DialogDescription>
                </DialogHeader>
