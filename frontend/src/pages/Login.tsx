        ...
        <div className="relative min-h-screen flex md:flex-row">
          ...
          <div className="flex-1 flex items-center justify-center p-4">
            <div className="w-full max-w-md space-y-8">
              ...
              <div className="bg-white/95 md:bg-white p-6 rounded-lg shadow-lg backdrop-blur-sm md:backdrop-blur-none">
          ...
          <div className="hidden md:block relative flex-1">
            <img
              src="/assets/popart.jpg"
              alt="Decorative"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-plansync-purple-950/30"></div>
          </div>
        </div>
      </div>
    </AuthGuard>
