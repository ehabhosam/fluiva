...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-plansync-purple-100 to-plansync-teal-50">
      <div className="text-center space-y-6">
        ...
        <h1 className="text-3xl font-bold text-plansync-purple-900">
          Page not found
        </h1>
        <p className="text-plansync-purple-700 max-w-md mx-auto">
